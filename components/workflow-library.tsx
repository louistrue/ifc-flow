...
export function WorkflowLibrary({ open, onOpenChange, onLoadWorkflow }: WorkflowLibraryProps) {
  const [workflows, setWorkflows] = useState(() => workflowStorage.getWorkflows())
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[900px] max-h-[80vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>Browse, manage, and load your saved workflows</DialogDescription>
        </DialogHeader>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 overflow-hidden flex flex-col">
          <div className="flex justify-between items-center mb-4">
            ...
            {activeTab === "library" && (
              <div className="flex gap-2">
                ...
                <Button variant="outline" className="gap-1" onClick={refreshWorkflows}>
                  Refresh
                </Button>
              </div>
            )}
          ...
          <TabsContent value="library" className="flex-1 overflow-hidden flex flex-col gap-4">
            {workflows.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-[400px] text-center">
                ...
                <p className="text-muted-foreground mb-4 max-w-md">
                  You don't have any saved workflows yet. Create a workflow and save it to your library, or import
                  existing workflows.
                </p>
                <Button onClick={() => setActiveTab("import")} className="gap-1">
              ...
              <div className="flex flex-col items-center justify-center h-[400px] text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  No workflows match your search term "{searchTerm}". Try a different search or browse all workflows.
                </p>
                      ...
                      <CardContent className="pb-2">
                        <div className="flex items-center text-xs text-muted-foreground gap-4 mb-2">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span>{workflow.flowData?.nodes?.length || 0} nodes</span>
                          </div>
                        </div>
          ...
          <TabsContent value="import" className="flex-1 overflow-auto">
            <div className="border rounded-md p-6 text-center flex flex-col items-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-md">
                Import a Grasshopper for IFC workflow file (.json) to add it to your library
              </p>
              ...
              {importSuccess && (
                <Alert className="mb-4 mx-auto max-w-md bg-green-50 text-green-900 border-green-200">
                  ...
                  <AlertDescription>Workflow was imported successfully</AlertDescription>
                </Alert>
              )}

              <input type="file" ref={fileInputRef} accept=".json" className="hidden" onChange={handleFileChange} />

              <Button onClick={handleImportClick} className="gap-2" disabled={isImporting}>
                {isImporting ? (
                  "Importing..."
                ) : (
                  <>
              ...
              <div className="text-left max-w-md mx-auto">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  Import requires a valid workflow JSON file that was previously exported from Grasshopper for IFC.
                </p>
                <p className="text-sm text-muted-foreground">
                  The file must contain a complete workflow with valid nodes and edges.
                </p>
              </div>
            </div>
          </TabsContent>
